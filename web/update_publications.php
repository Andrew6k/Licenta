<?php
    ...
    $query = "UPDATE publications SET title='$publication_title', year='$publication_year', conference='$publication_conference', citations='$citation_count' WHERE id='$publication_id'";
